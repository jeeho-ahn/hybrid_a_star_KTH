...
static const double width = 0.25 + 2 * bloating; // mushr
...
cost of the predecessor
  to allow the successor being plac  This would lead to the fact that the successor would never be placed and the the one cell could only expand one node. The tieBreaker artificially increases the ed in the same cell.
*/
